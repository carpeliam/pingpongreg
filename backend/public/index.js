...
/***/ function(module, exports, __webpack_require__) {
	...
	var _subscribeToSocketEvents = __webpack_require__(213);
	
	var _subscribeToSocketEvents2 = _interopRequireDefault(_subscribeToSocketEvents);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var initialState = { tables: [{ id: 1, queue: [] }] };
	...
	(0, _subscribeToSocketEvents2.default)(store.dispatch);
	...
	_reactDom2.default.render(_react2.default.createElement(Root, null), document.body.appendChild(document.createElement('div')));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    onReserveTable: function onReserveTable(tableId) {
	      return dispatch((0, _actions.reserveTable)(tableId));
	    },
	    onRemoveReservation: function onRemoveReservation(reservation) {
	      return dispatch((0, _actions.removeReservation)(reservation));
	    }
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.UPDATE_RESERVATIONS = exports.RECEIVE_TABLES = exports.RESERVE_TABLE = undefined;
	...
	var _fetchCurrentUser = __webpack_require__(199);
	
	var _fetchCurrentUser2 = _interopRequireDefault(_fetchCurrentUser);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var RESERVE_TABLE = exports.RESERVE_TABLE = 'RESERVE_TABLE';
	var RECEIVE_TABLES = exports.RECEIVE_TABLES = 'RECEIVE_TABLES';
	var UPDATE_RESERVATIONS = exports.UPDATE_RESERVATIONS = 'UPDATE_RESERVATIONS';
	
	function headers() {
	  return new Headers({ UserId: (0, _fetchCurrentUser2.default)() });
	}
	
	function receiveTables(tables) {
	  return { type: RECEIVE_TABLES, tables: tables };
	}
	
	function updateReservations(tableId, reservations) {
	  return { type: UPDATE_RESERVATIONS, tableId: tableId, reservations: reservations };
	}
	
	function fetchTables() {
	  return function (dispatch) {
	    return fetch('/tables').then(function (response) {
	      return response.json();
	    }).then(function (json) {
	      return dispatch(receiveTables(json));
	    });
	  };
	}
	...
	function reserveTable(tableId) {
	  return function () {
	    return fetch('/tables/' + tableId + '/reservations', { method: 'POST', headers: headers() });
	  };
	}
	
	function removeReservation(reservation) {
	  return function () {
	    return fetch('/reservations/' + reservation.id, { method: 'DELETE', headers: headers() });
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shortid = __webpack_require__(200);
	
	var _shortid2 = _interopRequireDefault(_shortid);
	
	var _jsCookie = __webpack_require__(209);
	...
	function fetchCurrentUser() {
	  var uid = _jsCookie2.default.get('userid');
	  if (!uid) {
	    uid = _shortid2.default.generate();
	    _jsCookie2.default.set('userid', uid);
	  }
	  return uid;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clusterWorkerId = __webpack_require__(208) || 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var randomFromSeed = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var randomByte = __webpack_require__(205);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Table(props) {
	  var currentPlayer = props.table.queue[0];
	  var leaveTableBtn = void 0;
	  if (currentPlayer) {
	    leaveTableBtn = _react2.default.createElement(
	      "button",
	      {
	        className: "leave-table",
	        onClick: function onClick() {
	          props.onRemoveReservation(currentPlayer);
	        }
	      },
	      "Leave"
	    );
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      "button",
	      {
	        ...
	        onClick: function onClick() {
	          props.onReserveTable(props.table.id);
	        },
	...
	Table.propTypes = {
	  ...
	  onReserveTable: _react2.default.PropTypes.func.isRequired,
	  onRemoveReservation: _react2.default.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function tables() {
	  ...
	  var list = _immutable2.default.fromJS(state);
	  switch (action.type) {
	    case _actions.RECEIVE_TABLES:
	      return action.tables;
	    case _actions.UPDATE_RESERVATIONS:
	      {
	        var tableIndex = list.findIndex(function (table) {
	          return table.get('id') === action.tableId;
	        });
	        return list.update(tableIndex, function (table) {
	          return table.setIn(['queue'], action.reservations);
	        }).toJS();
	      }
	    default:
	      return state;
	...
	exports.default = (0, _redux.combineReducers)({ tables: tables });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = subscribeToSocketEvents;
	
	var _actioncable = __webpack_require__(214);
	...
	function subscribeToSocketEvents(dispatch) {
	  var uid = (0, _fetchCurrentUser2.default)();
	  var cable = _actioncable2.default.createConsumer();
	  cable.subscriptions.create({ channel: 'TablesChannel', uid: uid }, {
	    // connected: () => console.log('connected'),
	    received: function received(_ref) {
	      var table_id = _ref.table_id;
	      var reservations = _ref.reservations;
	
	      dispatch((0, _actions.updateReservations)(table_id, reservations));
	    }
	  });
	}
